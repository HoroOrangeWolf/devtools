...
export const FileDropzone = ({ accept, onDropFile, children, className, isDisabled, displayShadow }: CsvFileDropzoneProps) => {
		...
		>
			...
			<div
				className={cn(
					...
					(!isActive && displayShadow && 'border-primary/70 text-primary opacity-100')
				)}
			>
